...
DEMO_USERS = [
    dict(
        ...
        # 학자금대출 잔액(8.4M)보다 한참 적게 잡아서 "여유자금 = 무조건 전액상환이 최선"
        liquid_assets_krw=2_000_000,
    ...
    dict(
        ...
        # 대출 두 건 합산 잔액(41.2M)에 한참 못 미쳐서 전액상환은 불가능하고,
        # 부분상환/대환 조합을 실제로 비교해봐야 하는 케이스가 되도록 잡았다
...
DEMO_LOANS = [
    dict(
        ...
        balance=8_400_000,
        interest_rate=2.30,
        rate_type="주기형",   # 학자금대출은 학기마다 금리가 재고시
